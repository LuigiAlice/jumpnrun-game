...
export class GameScene extends Phaser.Scene {
  ...
  private spawnEntities(level: LevelData) {
    ...
    level.platforms.forEach(p => {
      ...
      else if (platType === 'metal') tex = 'brick';
      else if (platType === 'wood') tex = 'ground_cave';
      else if (platType === 'sand') tex = 'ground_grass';
      else if (platType === 'snow') tex = 'ground_cave';
      else if (platType === 'lava') tex = 'brick';
      else if (platType === 'space') tex = 'ground_castle';
      else if (platType === 'sandstone') tex = 'brick';
      else if (platType === 'cloud') tex = 'cloud_block';
      else if (platType === 'water') tex = 'ground_cave';
