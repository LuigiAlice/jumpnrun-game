...
export const FOREST_LEVELS: LevelData[] = [
  {
    ...
    questionBlocks: (() => {
      ...
      return [
        ...
        createQB(8500 * S, 480, 'star'), createQB(10000 * S, 480, 'mushroom'), createQB(11800 * S, 480, 'flower'),
        createQB(13800 * S, 480, 'mushroom'), createQB(15600 * S, 480, 'star'), createQB(17500 * S, 150, 'flower'),
        createQB(19800 * S, 480, 'mushroom'), createQB(21000 * S, 480, 'star'), createQB(23200 * S, 480, 'flower'),
  ...
  },
  {
    ...
    questionBlocks: (() => {
      ...
      return [
        ...
        createQB(9500 * S, 530, 'star'), createQB(10500 * S, 530, 'mushroom'), createQB(12400 * S, 530, 'flower'),
        createQB(14100 * S, 530, 'mushroom'), createQB(16000 * S, 530, 'star'), createQB(18000 * S, 530, 'flower'),
        ...
        createQB(30000 * S, 530, 'flower'), createQB(31200 * S, 530, 'mushroom'), createQB(33800 * S, 530, 'star'),
      ];
    })(),
    enemies: (() => {
      const S = 0.556;
  ...
  },
  {
    ...
    questionBlocks: (() => {
      ...
      return [
        ...
        createQB(5100 * S, 580, 'star'), createQB(7300 * S, 580, 'flower'), createQB(9200 * S, 250, 'mushroom'),
        createQB(10400 * S, 580, 'star'), createQB(11500 * S, 580, 'mushroom'), createQB(13000 * S, 580, 'flower'),
        createQB(14500 * S, 580, 'mushroom'), createQB(15800 * S, 580, 'star'), createQB(18000 * S, 580, 'flower'),
        createQB(20000 * S, 580, 'mushroom'), createQB(22800 * S, 250, 'star'), createQB(24000 * S, 580, 'mushroom'),
        createQB(25200 * S, 580, 'flower'), createQB(26400 * S, 580, 'mushroom'), createQB(29000 * S, 580, 'star'),
        createQB(31500 * S, 580, 'flower'), createQB(32800 * S, 580, 'mushroom'), createQB(34200 * S, 580, 'star'),
  ...
  },
  {
    ...
    questionBlocks: (() => {
      ...
      return [
        ...
        createQB(6000 * S, 580, 'star'), createQB(8400 * S, 580, 'flower'), createQB(9500 * S, 580, 'mushroom'),
        createQB(10700 * S, 250, 'star'), createQB(11700 * S, 580, 'mushroom'), createQB(12900 * S, 580, 'flower'),
        createQB(14500 * S, 580, 'mushroom'), createQB(15900 * S, 580, 'star'), createQB(17200 * S, 580, 'flower'),
        createQB(19800 * S, 580, 'mushroom'), createQB(21000 * S, 580, 'star'), createQB(22200 * S, 580, 'mushroom'),
        createQB(25000 * S, 250, 'flower'), createQB(26300 * S, 580, 'mushroom'), createQB(27500 * S, 580, 'star'),
  ...
  },
  {
    ...
    questionBlocks: (() => {
      ...
      return [
        ...
        createQB(15800 * S, 530, 'mushroom'), createQB(17200 * S, 530, 'star'), createQB(18800 * S, 530, 'flower'),
        ...
        createQB(28200 * S, 200, 'flower'), createQB(29500 * S, 530, 'mushroom'), createQB(30700 * S, 530, 'star'),
        createQB(32400 * S, 530, 'flower'), createQB(33800 * S, 530, 'mushroom'), createQB(35600 * S, 530, 'star'),
        createQB(37100 * S, 530, 'flower'), createQB(38600 * S, 530, 'mushroom'), createQB(40100 * S, 530, 'star'),
        createQB(41600 * S, 530, 'mushroom'), createQB(42800 * S, 530, 'flower'), createQB(44200 * S, 530, 'mushroom'),
  ...
  },
  {
    ...
    questionBlocks: (() => {
      ...
      return [
        ...
        createQB(21000 * S, 530, 'mushroom'), createQB(22200 * S, 530, 'star'), createQB(23800 * S, 530, 'mushroom'),
        createQB(25400 * S, 530, 'flower'), createQB(26800 * S, 530, 'mushroom'), createQB(28200 * S, 530, 'star'),
